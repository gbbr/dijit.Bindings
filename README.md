...
After these actions are finished, it returns a linking function that takes a single parameter, the scope. In most cases, the scope is our widget. The linking function looks for models or properties within that scope to link against and creates a live link.
